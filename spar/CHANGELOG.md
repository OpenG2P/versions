...
- **Major:** Migration of repository from GitHub to GitLab, resulting in read-only access on GitHub with build and publish disabled.
- Build process reinstated on GitHub for publishing, ensuring continued availability of the project.
