...
| Version | Date | Type |
| --- | --- | --- |
| [`1.1.0-rc.61`](#v-1-1-0-rc-61) | 2026-08-26 | release candidate |
| [`0.0.0-develop.62`](#v-0-0-0-develop-62) | 2026-08-26 | develop |
| [`0.0.0-develop.60`](#v-0-0-0-develop-60) | 2026-08-24 | develop |

# Release candidates

<a id="v-1-1-0-rc-61"></a>

## platform-services/master-data-service 1.1.0-rc.61 — 2026-08-26

_commit `da81eb2` · changes since the start_
<!-- build:1.1.0-rc.61 revision:da81eb204da1872630142d4001d3ef7ce05334ff ts:1787731181 -->

**Chart:** [openg2p-master-data 1.1.0-rc.61](https://gitlab.com/api/v4/projects/openg2p%2Fcharts/packages/helm/stable/charts/openg2p-master-data-1.1.0-rc.61.tgz)

### Summary

- **Major:** Migration to GitLab CI, dropping GitHub Actions; updated Docker configurations and built geo db-seed image for deployment.
- Data model updates: removed obsolete agricultural and social codelists, simplified attribute and geo schemas, and enhanced geo management with new dialogs and localization.
- Feature enhancements: added master-data UI configuration, geo level management, and initial seed data for G2P attributes and values.
- API improvements: integrated registry database with IAM support, added new endpoints for geo levels, and fixed boot crash issues related to IAM configuration.
- Refactoring efforts: improved naming and annotations in IAM templates, consolidated repository structure, and optimized geo data loading processes for idempotency.
- Dependency updates: upgraded FASTAPI_COMMON_REF to version 1.2 and pinned IAM service reference to version 1.4.

### Changes

- [G2P-5586](https://openg2p.atlassian.net/browse/G2P-5586) Update FASTAPI_COMMON_REF to version 1.2 and change repository URL in Dockerfile and .gitlab-ci.yml ([`f6c2bc4`](https://gitlab.com/openg2p/platform-services/master-data-service/-/commit/f6c2bc41b1c66ccc91a7e70fd325ec5d6916841d))
- [G2P-5578](https://openg2p.atlassian.net/browse/G2P-5578) Refactor IAM register ConfigMap and Job templates for improved naming and annotations ([`3b1dae4`](https://gitlab.com/openg2p/platform-services/master-data-service/-/commit/3b1dae4711450994d4720113521a950f8ec1fa6d))
- [G2P-5576](https://openg2p.atlassian.net/browse/G2P-5576) Removed obsolete agricultural and social codelists, attributes, and unused schema entries, while updating social codelists with new livelihood values and attributes. ([`980d938`](https://gitlab.com/openg2p/platform-services/master-data-service/-/commit/980d938095e95d456c645d805082304af27e2681))
- Refactor attribute and geo schemas to remove unused fields and simplify data models ([`a84cf6b`](https://gitlab.com/openg2p/platform-services/master-data-service/-/commit/a84cf6ba162bc350fcb66e4ec57ebde3ec2fb657))
- [G2P-5574](https://openg2p.atlassian.net/browse/G2P-5574) Add component label to master-data-api deployment and service ([`f809fa7`](https://gitlab.com/openg2p/platform-services/master-data-service/-/commit/f809fa7db597b29e7f52460c9c04912b95b471b2))
