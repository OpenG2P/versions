...
## id-generator 1.1.1 — 2026-09-01

<!-- build:1.1.1 revision:6afff1cbaabc679c371cd66b3ebd7f3211a0bd3e ts:1787883057 -->

_commit `6afff1c` · changes since release 1.1.0_

**Same artifact as [`1.1.1-rc.47`](#v-1-1-1-rc-47)** — built from the
same commit and *promoted* (retagged), not rebuilt. No code changed between them.

**Chart:** [openg2p-id-generator 1.1.1](https://openg2p.github.io/openg2p-helm/openg2p-id-generator-1.1.1.tgz)

### Summary

- **Major:** Migration to GitLab for CI/CD, with the removal of GitHub Actions for build and publish processes.
- GitHub repository is now read-only, with build and publish functionalities disabled.
- Platform service group changes applied to the id-generator project.
