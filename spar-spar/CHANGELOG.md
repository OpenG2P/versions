...
**Repository:** [gitlab.com/openg2p/spar/spar](https://gitlab.com/openg2p/spar/spar) · **Container images:** [Container Registry](https://gitlab.com/openg2p/spar/spar/container_registry)
...
<a id="v-0-0-0-develop-33"></a>

## spar/spar — develop 0.0.0-develop.33 (2026-07-19)

_commit `1a71557` · baseline: release v1.0.0 · previous build 0.0.0-develop.32_
<!-- build:0.0.0-develop.33 revision:1a7155798e6de6f6abe6bfe109aa5902cc0e660d ts:1784433074 -->

### Summary

_All changes since release v1.0.0:_

- Removed the legacy Keymanager crypto backend from SPAR, including updates to configuration, Keycloak initialization dependency, chart, and uninstall script.
- Signing now uses local key verification instead of Keymanager.
- Switched CI from GitHub Actions to GitLab for build and publish processes.
- Integrated with the partner management service, adjusting names as PM is now installed via commons-services.
- Implemented a new CI configuration, aligning build-publish.yml boilerplate with organizational conventions.
- Fixed a Keycloak error and performed various cleanups.
- Automatic version bumping for the develop branch has been implemented.
- Bumped develop build ordinal past retired run-number versions to maintain versioning integrity.

### New in this build (since 0.0.0-develop.32)
...
## spar-spar — develop 0.0.0-develop.32 (2026-07-18)

_commit `db754ff` · baseline: release v1.0.0_
<!-- build:0.0.0-develop.32 revision:db754ff2f1e05cc1a77c28a7274dbb890f777dc3 ts:1784371867 -->

### Summary

_All changes since release v1.0.0:_

- Removed Keymanager; signing now uses local key verification instead.
- Switched CI from GitHub Actions to GitLab for build and publish processes.
- Integrated with partner management service; names adjusted as PM is now installed via commons-services.
- Implemented a new CI configuration aligned with organizational conventions.
- Bumped develop build ordinal past retired run-number versions to ensure continuity.
- Fixed Keycloak error to improve authentication reliability.
