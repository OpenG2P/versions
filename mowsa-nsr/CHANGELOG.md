...
## mowsa-nsr 1.2.0 — 2026-09-04

<!-- build:1.2.0 revision:3166cb9a308d0547e3b71d45eb9eb38b87b70dd1 ts:1788428032 -->

_commit `3166cb9` · changes since release v1.0.0_

**Same artifact as [`1.2.0-rc.304`](#v-1-2-0-rc-304)** — built from the
same commit and *promoted* (retagged), not rebuilt. No code changed between them.

**Chart:** [mowsa-nsr 1.2.0](https://openg2p.github.io/openg2p-helm/mowsa-nsr-1.2.0.tgz)

### Summary

_AI summary unavailable — re-run the workflow with `changelog_regenerate=1.2.0` to generate it._
