...
## registry-platform 1.2.0 — 2026-09-01

<!-- build:1.2.0 revision:41ae1aefc1ee9995f6cfb4b64faa69e8d9fadb10 ts:1788270073 -->

_commit `41ae1ae` · changes since release v1.0.0_

**Same artifact as [`1.2.0-rc.440`](#v-1-2-0-rc-440)** — built from the
same commit and *promoted* (retagged), not rebuilt. No code changed between them.

**Chart:** [openg2p-registry 1.2.0](https://openg2p.github.io/openg2p-helm/openg2p-registry-1.2.0.tgz)

### Release notes

## What's Changed
* 1.1 into develop by @venky-ganapathy in https://github.com/OpenG2P/registry-platform/pull/103
* Refactor tab/section api, controllers, and service by @tahzeer in https://github.com/OpenG2P/registry-platform/pull/115
* Add endpoint for allowed parents and enhance intake form services to process tree node links by @tahzeer in https://github.com/OpenG2P/registry-platform/pull/118
* 1.1 - > develop by @shibu-narayanan in https://github.com/OpenG2P/registry-platform/pull/117
* Add read-only user access for MinIO client configuration by @tahzeer in https://github.com/OpenG2P/registry-platform/pull/122
* Refactor payload validation in G2PChangeRequestSectionPayloadService by @tahzeer in https://github.com/OpenG2P/registry-platform/pull/129
* [G2P-5598](https://openg2p.atlassian.net/browse/G2P-5598) refactor: use search params for intake submission page by @Q-Niranjan in https://github.com/OpenG2P/registry-platform/pull/127


**Full Changelog**: https://github.com/OpenG2P/registry-platform/compare/1.1.3...1.2.0

### Summary

- **Major:** Updated core dependencies, including Docker images to version 1.2.0, FastAPI, and Keycloak initialization versions, enhancing overall compatibility and performance.
- New features: Implemented export functionality for register records, including APIs and background tasks, and added a configurable reference generator for intake forms.
- Refactoring: Enhanced intake submission handling with search parameters, improved payload validation in G2PChangeRequestSectionPayloadService, and streamlined document handling across various services.
- Security improvements: Added CSRF validation for staff-portal-api requests and client-side CSRF token handling to bolster application security.
- CI/CD updates: Transitioned CI workflows from GitHub Actions to GitLab, consolidating build and publish processes for all images and charts.
- Cleanup: Removed deprecated components and unused request parameters, including the data policies feature and legacy tab/section routes, to streamline the codebase.
- UI enhancements: Improved geo hierarchy management and document handling, updated UI widgets, and refined breadcrumb navigation for better user experience.
- Fixes: Addressed various bugs, including document upload size limits, boolean conditional visibility issues, and improved error handling across services.
...
_commit `9b41f96` · changes since v1.0.0_
<!-- build:1.2.0-rc.434 revision:9b41f961bd72824e184684152fd6ff6cb1d6921f ts:1787898169 -->

**Chart:** [openg2p-registry 1.2.0-rc.434](https://openg2p.github.io/openg2p-helm/openg2p-registry-1.2.0-rc.434.tgz)
