...
| Version | Date | Type |
| --- | --- | --- |
| [`1.4.0-rc.99`](#v-1-4-0-rc-99) | 2026-08-26 | release candidate |
| [`0.0.0-develop.96`](#v-0-0-0-develop-96) | 2026-08-24 | develop |

# Release candidates

<a id="v-1-4-0-rc-99"></a>

## platform-services/iam 1.4.0-rc.99 — 2026-08-26

_commit `2bc1eba` · changes since v1.3.0_
<!-- build:1.4.0-rc.99 revision:2bc1ebaef7acd1ed0a47a54cc7f7b85577451ada ts:1787731144 -->

**Chart:** [openg2p-iam-service 1.4.0-rc.99](https://gitlab.com/api/v4/projects/openg2p%2Fcharts/packages/helm/stable/charts/openg2p-iam-service-1.4.0-rc.99.tgz)

### Summary

- **Major:** Complete GitLab migration: switch CI to GitLab, port GitHub workflows, and drop .github; new CI implemented.
- Security enhancements: update FastAPI common library to version 1.2, add Keycloak initialization configuration, and refactor JWT validation using CryptoFactory.
- Feature additions: implement data policy management and middleware, enhance application management with Keycloak integration, and add roles and permissions management tabs.
- UI improvements: refactor application and login provider components for consistency, enhance modal styling, and introduce reusable UI components.
- Dependency updates: update Redis token TTLs for session management and fix templating for Keycloak base URL in IAM APIs.
- Testing improvements: add unit tests for IAM staff portal API components and improve coverage for core IAM functionality.
- Cleanup: remove unused SQL seed script and login providers JSON, and remove include_domains from attribute API calls.

### Changes

- [G2P-5592](https://openg2p.atlassian.net/browse/G2P-5592) Update Redis token TTLs and cache expiration for improved session management ([`1a1ca2b`](https://gitlab.com/openg2p/platform-services/iam/-/commit/1a1ca2b68810120c30d6f13a2a494b880a2b6dc9))
- [G2P-5587](https://openg2p.atlassian.net/browse/G2P-5587) Refactor GeoLocationPickerModal to use new utility functions for fetching geo levels and improve state management ([`b69ebd6`](https://gitlab.com/openg2p/platform-services/iam/-/commit/b69ebd628df3aeffa811d8acd0775b73a109adfb))
- [G2P-5581](https://openg2p.atlassian.net/browse/G2P-5581) Update FastAPI common library reference to version 1.2 and add Keycloak initialization configuration ([`bd43783`](https://gitlab.com/openg2p/platform-services/iam/-/commit/bd43783f8be1d179c58a24aecc47a3a8a2f3babf))
- [G2P-5581](https://openg2p.atlassian.net/browse/G2P-5581) Refactor JWT validation to use CryptoFactory and update tests for component registration ([`9d4d3c1`](https://gitlab.com/openg2p/platform-services/iam/-/commit/9d4d3c1ce970aca4b51d144ffb9470eb95906a75))
- [G2P-5578](https://openg2p.atlassian.net/browse/G2P-5578) Add registration for mds, awe, partner api ([`22af5d6`](https://gitlab.com/openg2p/platform-services/iam/-/commit/22af5d687c5ff99f03a6adf5ea97e6037b51c04e))
- [G2P-5576](https://openg2p.atlassian.net/browse/G2P-5576) Refactor DataPoliciesTab layout and comment out IconBase64Field in LoginProviderForm ([`6495993`](https://gitlab.com/openg2p/platform-services/iam/-/commit/649599302609de1af0604741c6fa5a74fe6f8e48))
- Remove include_domains from request payload in attribute API calls ([`dafa801`](https://gitlab.com/openg2p/platform-services/iam/-/commit/dafa801754b76a0e4591e48da0f47029c4ea4296))
- Fix templating for Keycloak base URL in IAM Staff and Agent APIs ([`ed5741a`](https://gitlab.com/openg2p/platform-services/iam/-/commit/ed5741a4cac7edafecf79d6f0b132869a605dd18))
