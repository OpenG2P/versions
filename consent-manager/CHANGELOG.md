...
| Version | Date | Type |
| --- | --- | --- |
| [`0.0.0-develop.48`](#v-0-0-0-develop-48) | 2026-07-16 | develop |

<a id="v-0-0-0-develop-48"></a>

## consent-manager — Unreleased (0.0.0-develop.48, 2026-07-16)

_commit `64fa696` · baseline: release the start_
<!-- build:0.0.0-develop.48 revision:64fa6965a4a6dcd68af70ba02290271a59deff09 -->
...
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) JWS support added for enhanced security.
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) Public keys are now stored in the database, with an option to query well-known keys.
- [G2P-5335](https://openg2p.atlassian.net/browse/G2P-5335) Publish consent-manager images and Helm chart to GitLab; dropped support for GitHub Container Registry (GHCR).
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) AWE is deactivated by default; it can be enabled if required, with sanity tests passing only if it is deactivated.
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) Deployment will fail if sanity tests do not pass.
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) e2e tests are now enabled by default.
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) Fixed issues related to multiple pods being created.
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) Race condition fix implemented.
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) Helm chart publish issue resolved.
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) Support for multiple modules using the same Consent Manager added.
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) Corrected Partner Management URLs and client names.
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) Sanity test job run added to ensure proper functionality.
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) FastAPI 'develop' version is now used.
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) Ensured sanity tests work with external p12 keys as well as demo keys.
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) Minor edits to README and changelog workflow input descriptions.
- [G2P-5335](https://openg2p.atlassian.net/browse/G2P-5335) Fixed startup failure by writing in the caller to satisfy reusable workflow.
- [G2P-5222](https://openg2p.atlassian.net/browse/G2P-5222) Cleanup and minor adjustments made throughout the codebase.
