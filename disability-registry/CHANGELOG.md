...
- **Major:** Enabled dashboards and shipped the Superset bundle, resolving issues with the import job and ensuring reporting views are functional.
- Workflow improvements: Fixed reporting views job to correctly map entity names and adjusted indexing rules to comply with PII regulations.
- Code cleanup: Removed unused factory classes and related imports from the disability extension to streamline the codebase.
- Build process: Reinstated build and publish functionality on GitHub, ensuring continuous integration is operational.
- Version bump: Updated RP version to 0.0.0-develop.384, reflecting ongoing development progress.
