## g2p-bridge/g2p-bridge 1.2.0-rc.104 — 2026-07-19

_commit `e812f7c` · baseline: release 1.1.0_
<!-- build:1.2.0-rc.104 revision:e812f7cdc817eea83c1ba5e229b0f049ffd7cb22 ts:1784450114 -->
...
- Changed the SPAR build dependency to point to the GitLab version `spar@develop`, replacing the previous GitHub version `openg2p-spar@2.0`.  
- Updated the FastAPI version to 'develop' for consistency across builds, while also pinning down a specific version for creating a frozen version.  
